...
const AstronautAnimation = () => {
  useEffect(() => {
    anime({
      //   targets: ".el", // Replace with the appropriate selector
      //   translateX: 100, // -> '250px'
      //   rotate: -360, // -> '540deg'
    ...
    <>
      ...
      >
        ...
        <path
          ...
          stroke-width="1px"
          d="M270.59,296.36c0,0-32.8-53.16-62.29-99.48c-26.62-40.5-41.43-83.81-41.43-128.5c0-46.59,13.77-90.47,37.05-128.99c22.5-37.25,51.76-67.56,88.52-88.95c38.51-21.86,83.43-31.25,133.29-30.75c46.12,0.51,89.56,10.88,129.2,27.57c39.61,16.69,76.19,38.18,109.86,65.3c33.6,27.1,64.32,58.41,91.08,93.57c27.03,35.88,50.55,75.87,70.04,119.61c19.49,43.74,35.43,90.76,47.47,141.51c12.04,50.75,18.05,104.37,18.05,159.69c0,55.33-5.96,109.72-16.92,162.05c-10.95,52.33-28.73,102.76-53.6,149.97c-24.85,47.21-57.22,88.59-97.9,121.06c-40.67,32.47-88.08,54.09-139.1,64.43c-51.01,10.34-104.93,15.51-158.56,15.51c-53.62,0-107.23-5.17-160.86-15.51c-51.02-10.34-98.43-31.96-139.1-64.43c-40.68-32.47-57.23-88.85-97.9-121.06c-24.87-47.21-42.65-97.64-53.6-149.97c-10.94-52.33-16.92-106.72-16.92-162.05c0-55.32,5.96-109.72,18.05-159.69c12.03-50.75,27.98-97.77,47.47-141.51c19.49-43.74,50.55-75.87,70.04-119"
        />
...
//   <div className="el" data-x="350">
{
  /* <h1>Welcome to My Component</h1>
          <p>This is a sample component with an Anime.js animation.</p> */
}
//     <div
//       style={{
//         width: "100px",
